...
| [Chiptone](https://sfbgames.itch.io/chiptone)  | Visual, powerful, online sound generator. |
...
| [Bosca Ceoil Blue](https://yurisizov.itch.io/boscaceoil-blue) | Easy music editor, great for beginners. Open Source. There's also an [online variant](https://humnom.net/apps/boscaceoil/).|
| [TIC-80](https://tic80.com) | While a full-featured fantasy console, you could just use its accessible music tracker. Open Source.|
...
| [TIC-80](https://tic80.com) | Fantasy console, similar to the popular but paid Pico-8. Customizable palette. Open Source.|
...
| [GDevelop](https://gdevelop.io) | 2D game engine letting you write logic without knowledge of coding. Open Source. |
| [Game Pencil](https://gamepencil.net) | A cross-platform 2D engine inspired by Unity & Game Maker, except Open Source. Uses JS scripting. |
...
| [LibGDX](https://libgdx.com) | Cross-platform Java framework with lots of features for both 2D and 3D. Open source. |
...
| [Nobiax Texture Pack](https://github.com/Fretek/NobiaxTexturePack)  | A pack of 1300+ quality textures and patterns. Public domain. |
...
| [Universal LPC Sprite Sheet Generator](https://liberatedpixelcup.github.io/Universal-LPC-Spritesheet-Character-Generator/) | Customizable character sprite sheets assembled from open art. |  
...
| [GifCam](https://blog.bahraniapps.com/gifcam/#download) | A lightweight tool for capturing Gifs from your screen  (Windows only). |
