    ...
    <div class="row">
      ...
      <div class="col-6">
        <div class="featured">
          ...
          <p>You can use either the embedded chat below 
              (<a href="https://kiwiirc.com/client/irc.afternet.org/?nick=user|?#alakajam" target="_akjchat">open in a new tab</a>),
              or your own preferred IRC client (e.g. <a href="https://hexchat.github.io/">HexChat</a>).</p>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
        <iframe src="https://kiwiirc.com/client/irc.afternet.org/?nick=noob|?#alakajam" style="border:0; width:100%; height:600px;">whop</iframe>
      </div>
    </div>
  </div>);
