...
<div class="panel">
  <ul class="nav nav-tabs nav-justified">
    <li role="presentation" class="js-tab-container active"><a class="js-tab-button" href="#tab1" data-tab-selector="#js-tab-1">Tab 1</a></li>
    <li role="presentation" class="js-tab-container"><a class="js-tab-button" href="#tab2" data-tab-selector="#js-tab-2">Tab 2</a></li>
  </ul>
...
module.exports = function tabs (options) {
  ...
  $(buttonSelector).click(function () {
    let $this = $(this)
    let activeTabSelector = $this.attr('data-tab-selector')
